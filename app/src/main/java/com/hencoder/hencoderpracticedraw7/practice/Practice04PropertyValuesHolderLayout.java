    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 第二个： scaleY 从 0 到 1
                // 第三个： alpha 从 0 到 1
                PropertyValuesHolder scaleXPropertyValuesHolder = PropertyValuesHolder
                        .ofFloat("scaleX", 0, 1);
                PropertyValuesHolder scaleYPropertyValuesHolder = PropertyValuesHolder
                        .ofFloat("scaleY", 0, 1);
                PropertyValuesHolder alphaPropertyValuesHolder = PropertyValuesHolder
                        .ofFloat("alpha", 0, 1);
                ObjectAnimator animator = ObjectAnimator.ofPropertyValuesHolder(view, scaleXPropertyValuesHolder,
                        scaleYPropertyValuesHolder, alphaPropertyValuesHolder);
                animator.start();
